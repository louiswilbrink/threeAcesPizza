        ...
        <div class="span6">
          <div class="hero-unit">
            ...
            foreach($xml->xpath("//Category") as $category){
              ...
              // Display only the "Lasagna" category for this page.
              if ($category['name'] == "Lasagna"){
              
                // Save Menu Category name.  Used later to generate form name.
                $cat = "" . $category['name'] . "";
                                
                // Iterate through menu items under Lasagna element.
                foreach($category->children() as $menu_item){
                  ...
                  foreach($menu_item->children() as $price){
                    ...
                    echo "  <form action='lrm.php' method='post'>";
          ...
          <div class="hero-unit">
            ...
            foreach($xml->xpath("//Category") as $category){
              ...
              // Display only the "Ravioli" category for this page.
              if ($category['name'] == "Ravioli"){
              
                // Save Menu Category name.  Used later to generate form name.
                $cat = "" . $category['name'] . "";
                                
                // Iterate through menu items under Ravioli element.
                foreach($category->children() as $menu_item){
                  echo "<div class='row-fluid'>";
          ...
          <div class="hero-unit">
            ...
            foreach($xml->xpath("//Category") as $category){
              ...
              // Display only the "Manicotti" category for this page.
              if ($category['name'] == "Manicotti"){
              
                // Save Menu Category name.  Used later to generate form name.
                $cat = "" . $category['name'] . "";
                                
                // Iterate through menu items under Manicotti element.
                foreach($category->children() as $menu_item){
                  echo "<div class='row-fluid'>";
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              foreach($_SESSION['My Order'] as $key=>$order){
                ...
                <form action='lrm.php' method='post'>
