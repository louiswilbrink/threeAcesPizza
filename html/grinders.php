        ...
        <div class="span6">
          <div class="hero-unit">
            ...
            foreach($xml->xpath("//Category") as $category){
              ...
              // Display only the "Grinder" category for this page.
              if ($category['name'] == "Grinder"){
              
                // Save Menu Category name.  Used later to generate form name.
                $cat = "" . $category['name'] . "";
                                
                // Iterate through the children of the Grinder element (each topping).
                foreach($category->children() as $menu_item){
                  ...
                  foreach($menu_item->children() as $size){
                    ...
                    foreach($size->children() as $price){
                      ...
                      echo "  <form action='grinders.php' method='post'>";
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              foreach($_SESSION['My Order'] as $key=>$order){
                ...
                <form action='grinders.php' method='post'>
