        ...
        <div class="span6">
          <div class="hero-unit">
            ...
            foreach($xml->xpath("//Category") as $category){
              ...
              // Display only the "Specialty Pizza" category for this page.
              if ($category['name'] == "Specialty Pizza"){
              
                // Save Menu Category name.  Used later to generate form name.
                $cat = "" . $category['name'] . "";
                                
                // Iterate through the children of the Pizza element (each topping).
                foreach($category->children() as $menu_item){
                  ...
                  foreach($menu_item->children() as $size){
                    ...
                    foreach($size->children() as $price){
                      ...
                      echo "  <form action='specialtypizza.php' method='post'>";
                      ...
                      echo "    <input type='hidden' name='price' value=" . $price->Price . " />";
                      
                      // Save size to $_POST if this item is added to shopping cart.
                      echo "    <input type='hidden' name='size' value=" . $price->getName() . " />";
                                        
                      // Display the size.
                      echo "  <div class='span3'>" . $price->getName() . "</div><!-- /.span -->";
                      
                      // Display the price.
                      echo "  <div class='span3'>$" . $price->Price . "</div><!-- /.span -->";
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              foreach($_SESSION['My Order'] as $key=>$order){
                ...
                <form action='specialtypizza.php' method='post'>
