        ...
        <div class="span6">
          <div class="hero-unit">
            ...
            foreach($xml->xpath("//Category") as $category){
              ...
              // Display only the "Wrap" category for this page.
              if ($category['name'] == "Wrap"){
              
                // Save Menu Category name.  Used later to generate form name.
                $cat = "" . $category['name'] . "";
                                
                // Iterate through menu items under Wrap element.
                foreach($category->children() as $menu_item){
                  ...
                  foreach($menu_item->children() as $price){
                    ...
                    echo "  <form action='wraps.php' method='post'>";
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              foreach($_SESSION['My Order'] as $key=>$order){
                ...
                <form action='wraps.php' method='post'>
