        ...
        <div class="span6">
          <div class="hero-unit">
            ...
            foreach($xml->xpath("//Category") as $category){
              ...
              // Display only the "Salad" category for this page.
              if ($category['name'] == "Salad"){
              
                // Save Menu Category name.  Used later to generate form name.
                $cat = "" . $category['name'] . "";
                                
                // Iterate through the children of the Salad element (each topping).
                foreach($category->children() as $menu_item){
                  ...
                  foreach($menu_item->children() as $size){
                    ...
                    foreach($size->children() as $price){
                      ...
                      echo "  <form action='salads.php' method='post'>";
